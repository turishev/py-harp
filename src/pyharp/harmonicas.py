...
harmonicas = {
    ...
    'major-cross' : {
        ...
        'scale': [
            ...
            Pitch(2, '7/1', Method.BLOW),
            Pitch(2, '1/2', Method.DRAW),
            Pitch(1, '2b/2', Method.OVERBLOW),

            Pitch(3, '2/2', Method.BLOW),
            Pitch(3, '3b/2', Method.DRAW_BEND1),
            Pitch(3, '3/2', Method.DRAW),

            Pitch(4, '4/2', Method.BLOW),
            Pitch(4, '5b/2', Method.DRAW_BEND1),
            Pitch(4, '5/2', Method.DRAW),
            Pitch(4, '6b/2', Method.OVERBLOW),

            Pitch(5, '6/2', Method.BLOW),
            Pitch(4, '7b/2', Method.DRAW_BEND1),
            Pitch(5, '7/2', Method.DRAW),

            Pitch(6, '1/3', Method.BLOW),
            Pitch(6, '2b/3', Method.DRAW_BEND1),
            Pitch(6, '2/3', Method.DRAW),
            Pitch(6, '3b/3', Method.OVERBLOW),

            Pitch(7, '3/3', Method.DRAW),
            Pitch(7, '4/3', Method.BLOW),
            Pitch(7, '5b/3', Method.OVERDRAW),

            Pitch(8, '5/3', Method.DRAW),
            Pitch(8, '6b/3', Method.BLOW_BEND1),
            Pitch(8, '6/3', Method.BLOW),
            Pitch(8, '7b/3', Method.OVERDRAW),

            Pitch(9, '7/3', Method.DRAW),
            Pitch(9, '1/4', Method.BLOW),
            Pitch(9, '2b/4', Method.OVERDRAW),

            Pitch(10, '2/4', Method.DRAW),
            Pitch(10, '3b/4', Method.BLOW_BEND1),
            Pitch(10, '3/4', Method.BLOW),
            Pitch(10, '4/4', Method.OVERDRAW),
        ],
    },
    'orchestra-s': {
    ...
    'natural-minor' : {
        ...
        'scale' : [
            ...
            Pitch(2, '6b/1', Method.BLOW),
            Pitch(2, '6/1', Method.DRAW_BEND3),
            Pitch(2, '7b/1', Method.DRAW_BEND2),
            Pitch(2, '7/1', Method.DRAW_BEND1),
            Pitch(2, '1/2', Method.DRAW),

            Pitch(3, '1/2', Method.BLOW),
            Pitch(3, '2b/2', Method.DRAW_BEND2),
            Pitch(3, '2/2', Method.DRAW_BEND1),
            Pitch(3, '3b/2', Method.DRAW),
            Pitch(3, '3/2', Method.OVERBLOW),
            ...
            Pitch(5, '6b/2', Method.BLOW),
            Pitch(5, '6/2', Method.DRAW_BEND1),
            Pitch(5, '7b/2', Method.DRAW),
            Pitch(5, '7/2', Method.OVERBLOW),
            ...
            Pitch(8, '5/3', Method.DRAW),
            Pitch(8, '6b/3', Method.BLOW),

            Pitch(9, '7b/3', Method.DRAW),
            Pitch(9, '7/3', Method.BLOW_BEND1),
            Pitch(9, '1/4', Method.BLOW),
            Pitch(9, '2b/4', Method.OVERDRAW),
    ...
    'harmonic-minor' : {
        ...
        'scale' : [
            ...
            Pitch(2, '3b/1', Method.BLOW),
            Pitch(2, '3/1', Method.DRAW_BEND3),
            Pitch(2, '4/1', Method.DRAW_BEND2),
            Pitch(2, '4b/1', Method.DRAW_BEND1),
            Pitch(2, '5/1', Method.DRAW),
            ...
            Pitch(5, '3b/2', Method.BLOW),
            Pitch(5, '3/1', Method.DRAW_BEND1),
            Pitch(5, '4/2', Method.DRAW),
            Pitch(5, '5b/2', Method.OVERBLOW),

            Pitch(6, '5/2', Method.BLOW),
            Pitch(6, '6b/2', Method.DRAW),
            Pitch(6, '6/2', Method.OVERBLOW),
            # 7b ? Method.OVERBLOW2 -?
            Pitch(7, '7/2', Method.DRAW),
            Pitch(7, '1/3', Method.BLOW),

            Pitch(8, '2/3', Method.DRAW),
            Pitch(8, '3b/3', Method.BLOW),
            ...
            Pitch(10, '6b/3', Method.DRAW),
            Pitch(10, '6/3', Method.BLOW_BEND3),
            Pitch(10, '7b/3', Method.BLOW_BEND2),
            Pitch(10, '7/3', Method.BLOW_BEND1),
            Pitch(10, '1/4', Method.BLOW),
            Pitch(10, '2b/4', Method.OVERDRAW),
    ...
    'wilde-tuned' : {
        ...
        'scale' : [
            ...
            # changed
            Pitch(6, '3/2', Method.BLOW),
            Pitch(6, '4/2', Method.DRAW_BEND2),
            Pitch(6, '5b/2', Method.DRAW_BEND1),
            Pitch(6, '5/2', Method.DRAW),
            Pitch(6, '6b/2', Method.OVERBLOW),

            Pitch(7, '5/2', Method.BLOW),
            Pitch(7, '6b/2', Method.DRAW_BEND3),
            Pitch(7, '6/2', Method.DRAW_BEND2),
            Pitch(7, '7b/2', Method.DRAW_BEND1),
            Pitch(7, '7/2', Method.DRAW),
            ...
            Pitch(9, '3/3', Method.BLOW),
            Pitch(9, '4/3', Method.DRAW_BEND2),
            Pitch(9, '5b/3', Method.DRAW_BEND1),
            Pitch(9, '5/3', Method.DRAW),
            Pitch(9, '6b/3', Method.OVERBLOW),
